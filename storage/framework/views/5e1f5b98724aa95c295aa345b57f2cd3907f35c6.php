    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                ?>
                <form id="form" method="post" action="<?php echo e(URL::to('add-category-action')); ?>">
...
<?php echo $__env->make('admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-project\resources\views/admin-pages/category-add.blade.php ENDPATH**/ ?>