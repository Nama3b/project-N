      ...
      <div class="row">
        ...
        <div class="col-10">
          <div class="feature-product">
            <div class="d-flex">
              <div class="col-6">
               <?php $__currentLoopData = $category_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <p>Home / Product / <?php echo e($cat_name->category_name); ?></p>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-project\resources\views/pages/category/show-product-by-category.blade.php ENDPATH**/ ?>