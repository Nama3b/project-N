<?php $__env->startSection('rent'); ?>

<section id="rent-header">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 d-flex">
                <div class="col-4">
                    <div class="rent-welcome mt-5 ml-4">
                        <h4><b>Thoải mái thuê đồ <br>không lo chất lượng</b></h4>
                ...
                <div class="col-8"><img src="<?php echo e('public/frontend/images/banner/rent-banner.png'); ?>" alt="" width="100%"></div>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce-project\resources\views/pages/rent.blade.php ENDPATH**/ ?>