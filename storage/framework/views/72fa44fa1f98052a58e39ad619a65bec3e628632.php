...
<head>
    ...
    <link href="<?php echo e('../public/front-end/img/logo.png'); ?>" rel="icon">
    <link rel="stylesheet" href="<?php echo e('public/front-end/css/index.css'); ?>">
    <link rel="stylesheet" href="<?php echo e('../public/front-end/css/index.css'); ?>">

    <link rel="stylesheet" href="<?php echo e('public/front-end/assets/fontawesome/css/all.css'); ?>">
    <link rel="stylesheet" href="<?php echo e('../public/front-end/assets/fontawesome/css/all.css'); ?>">
    <link rel="stylesheet" href="<?php echo e('public/front-end/assets/font-awesome-4.7.0/css/font-awesome.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo e('../public/front-end/assets/font-awesome-4.7.0/css/font-awesome.min.css'); ?>">
...
<body>
              ...
              <!-- Brand/logo -->
                <div class="nav-left col-6 d-flex fade-in">
                    <a class="navbar-brand" href="<?php echo e(URL::to('home')); ?>">
                        <img src="<?php echo e('public/front-end/img/16559063 (1).png'); ?>" alt="">
                        <img src="<?php echo e('../public/front-end/img/16559063 (1).png'); ?>" alt="">
                    </a>
                    <form class="form-search" method="post" action="<?php echo e(URL::to('search-product')); ?>">
                ...
                <div class="nav-right col-6 d-flex fade-in slide-in">
                    <ul class="navbar-nav slide-in">
                        <li class="nav-item active">
                            <a class="nav-link" href="<?php echo e(URL::to('home')); ?>">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(URL::to('product')); ?>">Product</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(URL::to('feature')); ?>">Feature</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(URL::to('partner')); ?>">Partners</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(URL::to('client')); ?>">Clients</a>
                        </li>
                    </ul>
                    <?php
                        ...
                        if($client_id == NULL){
                    ?>
                        <button class="btn btn-dark btn-signup"><a href="<?php echo e(URL::to('login')); ?>">Sign Up</a></button>
                        <button class="btn btn-outline-dark btn-cart"><a href="<?php echo e(URL::to('login')); ?>">Cart <i class=" fab fa-bitbucket"></i></a></button>
                    <?php
                    }else{
                    ?>
                        <div class="dropdown d-flex">
                          <button class="btn btn-outline-dark" type="button" data-toggle="dropdown">
                            <img src="<?php echo e('public/front-end/img/b5701597aecbaefeb4ca8c341ff5bff9.jpg'); ?>" alt="" width="37px">
                          </button>
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <hr>
                            <li><a href="<?php echo e(URL::to('logout-client')); ?>" style="color:red">Logout</a></li>
                          </ul>
                        </div>
                        <button class="btn btn-outline-dark btn-cart"><a href="<?php echo e(URL::to('show-cart')); ?>">Cart <i class="fab fa-bitbucket"></i></a></button>
                    <?php } ?>
                </div>
            </nav>
        </div>
    ...
    <footer>
        <div class="container-fluid">
            ...
            <div class="d-flex cre">
                <div class="col-3">
                    <img src="<?php echo e('public/front-end/img/16559063 (1).png'); ?>" alt="" width="90%">
                </div>
                <div class="col-2">
                    <ul>
                ...
                <div class="col-2">
                    <ul>
                        ...
                        <li><a href="<?php echo e(URL::to('dashboard')); ?>" style="color:black">Qui</a> officia architecto nobis?</li>
    ...
    <script src="<?php echo e('public/front-end/assets/js/index.js'); ?>"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\laravel-project\resources\views/layout.blade.php ENDPATH**/ ?>