      ...
      <div class="header-right col-6 d-flex">
        ...
        <div class="dropdown">
          <button class="btn btn-outline-light" type="button" data-toggle="dropdown">
            <img src="<?php echo e('public/back-end/img/b5701597aecbaefeb4ca8c341ff5bff9.jpg'); ?>" alt="" width="40px">
          </button>
          ...
          <ul class="dropdown-menu">
            ...
            <hr>
            <li><a href="<?php echo e(URL::to('logout-action')); ?>">Logout</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-project\resources\views/admin-pages/dashboard.blade.php ENDPATH**/ ?>