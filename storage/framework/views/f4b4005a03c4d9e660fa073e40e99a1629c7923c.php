                    ...
                    <ul class="nav navbar-nav ml-auto cat-list">
                        <li class="nav-item nav-item-dad">
                            ...
                            <div id="submenu-1" class="submenu collapse">
                                <ul class="nav flex-column">
                                    <li class="nav-item"><a href="admin.php?module=book-list-category" class="nav-link">Danh mục</a></li>
                                    <li class="nav-item"><a href="admin.php?module=book-list-product" class="nav-link">Sản phẩm</a></li>
                                    <li class="nav-item"><a href="admin.php?module=book-review" class="nav-link">Đánh giá sản phẩm</a></li>
                                    <li class="nav-item"><a href="admin.php?module=book-review-waiting" class="nav-link">Sản phẩm chờ duyệt</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item nav-item-dad">
                        ...
                        <li class="nav-item nav-item-dad">
                            ...
                            <div id="submenu-3" class="submenu collapse">
                                <ul class="nav flex-column">
                                    <li class="nav-item"><a href="admin.php?module=post-all" class="nav-link">Tài khoản người bán</a></li>
                                    <li class="nav-item"><a href="admin.php?module=post-waiting" class="nav-link">Tài khoản khách</a></li>
                                    <li class="nav-item"><a href="admin.php?module=post-approved" class="nav-link">Tài khoản người bán chờ duyệt</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item nav-item-dad">
                            <a href="" class="dad-nav-link" data-toggle="collapse" data-target="#submenu-4" aria-expanded="false">
                                <i class="fas fa-user-cog mr-1"></i> Quản lý admin
                            </a>
